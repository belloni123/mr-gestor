...
function ProviderStatus({ name, status, description }: { name: string; status: string; description: string }) {
  ...
  return (
    <div className="provider-status">
      ...
      <span className={connected ? "status status-good" : "status status-warning"}>{status}</span>
    </div>
  );
}
